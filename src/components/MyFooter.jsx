    ...
    return (
        <footer className="bg-dark text-white py-4 mt-5">
            <Container>
                <Row>
                    <Col sm={12} md={4}>
                        ...
                        <ul className="list-unstyled">
                            ...
                            <li><Nav.Link as={Link} to="/catalogo" className="text-white">Catalogo</Nav.Link></li>
                            <li><Nav.Link as={Link} to="/popolari" className="text-white">Più Popolari</Nav.Link></li>
                            <li><Nav.Link as={Link} to="/uscite" className="text-white">In Uscita</Nav.Link></li>
                        </ul>
                    </Col>
                    <Col sm={12} md={4}>
                        <h5>Contatti</h5>
                        <ul className="list-unstyled">
                            <li><a href="mailto:info@epibooks.it" className="text-white">info@epibooks.it</a></li>
                ...
                <p className="text-center text-secondary mb-0">&copy; 2025 EpiBooks. Tutti i diritti riservati.</p>
            </Container>
        </footer>
    )
}
